 ...
 * to setPointText() and setPointColor() to addFront items to the canvas.
 *
 */
public class Canvas {
    ...
    public void setPointText(int x, int y, char ch) {
    ...
    public void setPointColor(int x, int y, Color colour) {
        boolean isOkX = (x >= 0) && (x < sizeX);
        boolean isOkY = (y >= 0) && (y < sizeY);
        if (isOkX && isOkY) {
            color[y][x] = colour;
